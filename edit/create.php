...
<body>
    <div class="header">
        <div class="title-kuang">
            <div class="title container"><img src="./imgs/logo01.jpg" alt="LOGO">旺旺棋牌游戏开发公司</div>
        </div>
        <div class="nav-kuang">
        ...
        <div class="swiper-container">
            <div class="swiper-wrapper">
                <div class="swiper-slide">
                    <img src="./imgs/banner01.jpg" alt="banner01">
                </div>
                <div class="swiper-slide">
                    <img src="./imgs/banner02.jpg" alt="banner02">
                </div>
                <div class="swiper-slide">
                    <img src="./imgs/banner03.jpg" alt="banner03">
                </div>
            </div>
            <!-- 如果需要分页器 -->
        ...
        <div class="row">
                ...
                <div class="panel-group table-responsive" role="tablist">
                        ...
                        <ul class="search_info">
                            <li>
                                <div class="input-group">
                                    <input type="text" class="form-control" placeholder="请输入产品关键字">
                    ...
                    <div class="panel panel-primary leftMenu">
                        ...
                        <ul class="contact_info">
                            <li><b>旺旺棋牌游戏开发公司</b></li>
                            <li><i>地址：</i><span>北京市海淀区</span></li>
                            <li><i>联系人：</i><span>刘经理  </span></li>
                            <li><i>手机：</i><span>18885047283</span></li>
                            <li><i>微信：</i><span><a href="javascript:;">ww18885047283</a></span></li>
                            <li><img style="width:100%" src="./imgs/qrcode.png" alt="placeholder+image"></li>
                        </ul>
                    </div>
            ...
            <div class="col-md-9">
                <div class="bread-nav">
                    <ol class="breadcrumb">
                        <li>您现在的位置在：</li>
                        <li><a href="./index.html">旺旺棋牌游戏开发公司</a></li>
                        <li><a href="./index.html">首页</a></li>
                        <li class="active">' . $_REQUEST["name"] . '</li>
                    </ol>
                </div>
            </div>
            <div class="products-show col-md-9">
';
$foot = '
        </div>
    </div>
    ...
    <div id="legoobt">&nbsp;
        技术支持： <a href="https://github.com/bruce-zxy" target="_blank">bruce_zxy</a>&nbsp;&nbsp;
